...
uint8_t ad_data[22] = {
    ...
    9, AD_TYPE_COMPLETE_LOCAL_NAME, 'C', 'S', 'C', 'B', '_', 'd', 'e', 'v',  /* Complete name */
 ...
 */
#if (P2P_SERVER1 != 0)
static const char local_name[] = { AD_TYPE_COMPLETE_LOCAL_NAME ,'T','D','E','A','p'};
